...
###   This script attempts to download the signature file SHA256SUMS.asc from 5gl.info
...
SIGNATUREFILE="https://5gl.info/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://5gl.info/bin/"
VERSIONPREFIX="5gl-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix '5gl-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[5gl-]<version>-[rc[0-9]] (example: 5gl-0.9.2-rc1)"
   echo "wget output:"
