...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    C5GLAddress demoAddress = C5GLAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    C5GLAddress setaccountDemoAddress = C5GLAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(C5GLAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(C5GLAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
