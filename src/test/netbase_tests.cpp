...
{
    BOOST_CHECK(TestSplitHost("www.5gl.info", "www.5gl.info", -1));
    BOOST_CHECK(TestSplitHost("[www.5gl.info]", "www.5gl.info", -1));
    BOOST_CHECK(TestSplitHost("www.5gl.info:80", "www.5gl.info", 80));
    BOOST_CHECK(TestSplitHost("[www.5gl.info]:80", "www.5gl.info", 80));
...
{
    // values from https://web.archive.org/web/20181122003543/http://www.cypherpunk.at/onioncat/wiki/OnionCat
