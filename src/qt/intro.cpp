...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/5gl"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("5GL Core"),
     ...
     * override -datadir in the 5gl.conf file in the default data directory
     * (to be consistent with 5gld behavior)
     */
    if(dataDir != getDefaultDataDirectory())
