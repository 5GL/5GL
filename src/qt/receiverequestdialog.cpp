...
#include "config/5gl-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::format5GLURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + 5GLUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::format5GLURI(info));
}
