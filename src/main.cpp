...
#if defined(NDEBUG)
# error "5GL cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "5GL Signed Message:\n";
...
bool ConnectBlock(const CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    // See BIP30 and http://r6.ca/blog/20180206T005236Z.html for more information.
    // This logic is not necessary for memory pool transactions, as AcceptToMemoryPool
    // already refuses previously-known transaction ids entirely.
    // This rule was originally applied all blocks whose timestamp was after March 15, 2018, 0:00 UTC.
    ...
    // BIP16 didn't become active until Apr 1 2018
...
bool CheckBlock(const CBlock& block, CValidationState& state, bool fCheckPOW, bool fCheckMerkleRoot)
{
    ...
    if (fCheckMerkleRoot) {
        ...
        // Check for merkle tree malleability (CVE-2018-2459): repeating sequences
