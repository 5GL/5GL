...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use 5gld, or the -server option to 5gl-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"5GL Alert\" admin@foo.com\n"),
...
std::string HelpExampleCli(string methodname, string args){
    return "> 5gl-cli " + methodname + " " + args + "\n";
}
