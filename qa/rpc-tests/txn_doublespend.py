...
class TxnMallTest(5GLTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 5gl:
        ...
        # First: use raw transaction API to send 1210 5gl to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 505gl for another
        ...
        # Node0's total balance should be starting balance, plus 1005gl for 
