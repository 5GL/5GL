...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars 5GLD and 5GLCLI may be used to specify the exact binaries used"
        exit 1
fi
...
$5GLD -zapwallettxes=1 $B1ARGS &
B1PID=$!
$5GLD -zapwallettxes=2 $B2ARGS &
B2PID=$!
