The following is a list of assets used in the 5gl source and their proper attribution.
...
* License: MIT
* Site: [https://5gltalk.org/index.php?topic=15276.0](https://5gltalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original 5gl logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/5gl.icns, src/qt/res/src/5gl.svg,
	src/qt/res/src/5gl.ico, src/qt/res/src/5gl.png,
	src/qt/res/src/5gl_testnet.png, docs/5gl_logo_doxygen.png,
